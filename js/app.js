...
;(function() {
  ...
  function ensureTabBarStyles(){
    ...
    s.textContent = ''
      ...
      // List tab: keep brand-coloured pill icon as a visual accent (in-line with the bar, not floating)
      + '.tab-list-item .tab-list-circle{'
      +   'width:28px;height:22px;display:flex;align-items:center;justify-content:center;'
      +   'background:linear-gradient(135deg,#1a5c45 0%,#0e3d2e 100%);'
      +   'border-radius:8px;'
      +   'box-shadow:0 2px 6px rgba(26,92,69,.32)'
      + '}'
      + '.tab-list-item .tab-list-circle svg{width:14px;height:14px;stroke:#fff;fill:none;stroke-width:2.6}'
      + '.tab-list-item .tab-list-label{font-size:10.5px;font-weight:500;color:#1a1a1a}'

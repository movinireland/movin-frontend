...
;(function comingSoonGate(){
  ...
  function showGate(){
    ...
    style.textContent = ''
      ...
      + '#movin-cs-social{display:flex;gap:10px;justify-content:center;margin-top:1.5rem}'
      + '#movin-cs-social a{display:inline-flex;align-items:center;justify-content:center;'
      +   'width:38px;height:38px;border-radius:50%;background:rgba(255,255,255,.06);'
      +   'border:1px solid rgba(255,255,255,.10);color:rgba(255,255,255,.75);'
      +   'text-decoration:none;transition:background .2s,color .2s,transform .2s,border-color .2s}'
      + '#movin-cs-social a:hover{background:rgba(255,255,255,.14);color:#fff;'
      +   'border-color:rgba(126,201,168,.5);transform:translateY(-2px)}'
      + '#movin-cs-social a svg{display:block}'
      + '#movin-cs-foot{font-size:11.5px;color:rgba(241,235,220,.42);margin-top:1.75rem;letter-spacing:.3px;}'
    ...
    overlay.innerHTML = ''
      ...
      +   '<div id="movin-cs-social">'
      +     '<a href="https://www.instagram.com/movinireland" target="_blank" rel="noopener" aria-label="Movin on Instagram" title="Instagram">'
      +       '<svg viewBox="0 0 24 24" width="18" height="18" fill="none" stroke="currentColor" stroke-width="1.8" stroke-linecap="round" stroke-linejoin="round" aria-hidden="true"><rect x="2" y="2" width="20" height="20" rx="5"/><path d="M16 11.37a4 4 0 1 1-7.92 1.18A4 4 0 0 1 16 11.37z"/><line x1="17.5" y1="6.5" x2="17.51" y2="6.5"/></svg>'
      +     '</a>'
...
function mvInjectChromeStyles(){
  ...
  s.textContent = [
    ...
    '[data-theme="dark"] .nav-links li{ color:#e8e4d6 !important }',
    '[data-theme="dark"] .nav-links li:hover, [data-theme="dark"] .nav-links li.active{ color:#7ec9a8 !important }',
    '[data-theme="dark"] .nav-right .theme-toggle{ background:#242219 !important; color:#7ec9a8 !important }',
    '[data-theme="dark"] .nav-right .theme-toggle:hover{ background:#2ecc8a !important; color:#0e3d2e !important }',
    '[data-theme="dark"] .nav-right > a.btn-ghost{ color:#7ec9a8 !important; border-color:#7ec9a8 !important }',
    '[data-theme="dark"] .nav-right > a.btn-ghost:hover{ background:#7ec9a8 !important; color:#0e3d2e !important }',
    '[data-theme="dark"] .nav-user{ border-color:#38342a !important }',
    '[data-theme="dark"] .nav-user:hover{ background:#242219 !important; border-color:#7ec9a8 !important }',
    '[data-theme="dark"] .nav-user-name{ color:#f1ebdc !important }',
    '[data-theme="dark"] .nav-tools-dropdown{ background:#1c1b16 !important; border-color:#38342a !important; box-shadow:0 18px 40px -16px rgba(0,0,0,.6) !important }',
    '[data-theme="dark"] .ntd-item:hover{ background:#242219 !important }',
    '[data-theme="dark"] .ntd-title{ color:#f1ebdc !important }',
    '[data-theme="dark"] .ntd-sub{ color:#a8a496 !important }',
    '[data-theme="dark"] .ntd-icon{ background:#242219 !important }',
    '[data-theme="dark"] .ntd-icon svg{ stroke:#7ec9a8 !important }',
